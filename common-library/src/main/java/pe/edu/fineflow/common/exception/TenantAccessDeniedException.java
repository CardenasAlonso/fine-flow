...
/**
 * Se lanza cuando un usuario intenta acceder a un recurso de otro colegio. El API Gateway nunca
 * debería dejar pasar esto, pero existe como defensa en profundidad.
 */
