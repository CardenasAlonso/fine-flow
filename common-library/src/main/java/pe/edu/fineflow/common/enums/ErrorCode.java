...
public enum ErrorCode {
    ...
    TENANT_INACTIVE(
            "TENANT_002", "La institución está inactiva o suspendida", HttpStatus.FORBIDDEN),
    TENANT_MISSING(
            "TENANT_003",
            "No se pudo determinar la institución del request",
            HttpStatus.BAD_REQUEST),
    SUBSCRIPTION_EXPIRED(
            "TENANT_004", "La suscripción del colegio ha expirado", HttpStatus.PAYMENT_REQUIRED),
    ...
    PERIOD_OVERLAP(
            "ACAD_002", "Ya existe un período académico activo para este año", HttpStatus.CONFLICT),
    SCORE_OUT_OF_RANGE("ACAD_003", "La nota debe estar entre 0 y 20", HttpStatus.BAD_REQUEST),

    // Blockchain
    BLOCKCHAIN_IMMUTABLE(
            "BC_001", "Los bloques del blockchain no pueden ser modificados", HttpStatus.FORBIDDEN),
