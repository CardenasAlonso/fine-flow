...
public interface StudentScoreRepositoryPort {
    ...
    Flux<StudentScore> findByStudentIdAndSchoolId(String studentId, String schoolId, int offset, int limit);

    Flux<StudentScore> findByClassTaskIdAndSchoolId(String classTaskId, String schoolId, int offset, int limit);
