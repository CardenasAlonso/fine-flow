...
@Service
public class RegisterScoreUseCaseImpl implements RegisterScoreUseCase {

    private final StudentScoreRepositoryPort repo;
    private final EventBus eventBus;

    public RegisterScoreUseCaseImpl(StudentScoreRepositoryPort repo, EventBus eventBus) {
        this.repo = repo;
