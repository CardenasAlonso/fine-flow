package pe.edu.fineflow.evaluation.application.usecase;
...
@Service
public class JustificationUseCaseImpl implements ManageJustificationUseCase {

    private final JustificationRepositoryPort repo;

    public JustificationUseCaseImpl(JustificationRepositoryPort repo) {
        this.repo = repo;
    }
