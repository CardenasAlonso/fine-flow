...
@Service
public class ManageStudentUseCaseImpl extends BaseTenantService<Student> implements ManageStudentUseCase {

    private final StudentRepositoryPort repo;
    private final EventBus eventBus;

    public ManageStudentUseCaseImpl(StudentRepositoryPort repo, EventBus eventBus) {
        this.repo = repo;
