...
@Service
public class ManageTeacherUseCaseImpl extends BaseTenantService<Teacher> implements ManageTeacherUseCase {
    private final TeacherRepositoryPort repository;

    public ManageTeacherUseCaseImpl(TeacherRepositoryPort repository) {
