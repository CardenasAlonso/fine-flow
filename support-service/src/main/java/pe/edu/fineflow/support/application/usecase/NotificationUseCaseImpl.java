...
@Service
public class NotificationUseCaseImpl implements ManageNotificationUseCase {
    ...
    public NotificationUseCaseImpl(NotificationRepositoryPort repo, EventBus eventBus) {
        this.repo = repo;
