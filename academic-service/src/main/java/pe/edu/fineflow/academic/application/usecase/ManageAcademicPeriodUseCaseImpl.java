...
public class ManageAcademicPeriodUseCaseImpl extends BaseTenantService<AcademicPeriod> implements ManageAcademicPeriodUseCase {
    private final AcademicPeriodRepositoryPort repository;

    public ManageAcademicPeriodUseCaseImpl(AcademicPeriodRepositoryPort repository) {
