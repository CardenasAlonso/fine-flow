...
public class ManageClassroomUseCaseImpl extends BaseTenantService<Classroom> implements ManageClassroomUseCase {
    private final ClassroomRepositoryPort repository;

    public ManageClassroomUseCaseImpl(ClassroomRepositoryPort repository) {
