...
public class ManageClassTaskUseCaseImpl extends BaseTenantService<ClassTask> implements ManageClassTaskUseCase {
    private final ClassTaskRepositoryPort repository;

    public ManageClassTaskUseCaseImpl(ClassTaskRepositoryPort repository) {
