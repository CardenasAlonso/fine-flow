...
@Service
public class ManageStudentSectionHistoryService implements ManageStudentSectionHistoryUseCase {

    private final StudentSectionHistoryRepositoryPort repo;

    public ManageStudentSectionHistoryService(StudentSectionHistoryRepositoryPort repo) {
        this.repo = repo;
    }
